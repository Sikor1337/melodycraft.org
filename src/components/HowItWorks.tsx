    ...
    <section id="how-it-works" className="py-28 hairline">
      <div className="container mx-auto px-6">
        <div className="max-w-2xl mb-16">
          <p className="text-sm font-medium text-amber-400 mb-4">How it works</p>
        ...
        <button
          ...
          className="group inline-flex items-center gap-2 text-white font-medium hover:text-amber-400 transition-colors"
        >
          Start your song
