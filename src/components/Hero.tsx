  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 pb-20 overflow-hidden hero-gradient">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          Studio-quality custom songs in 24 hours. <br className="hidden md:block" />
          Your vision, brought to life by AI and professional producers.
        </motion.p>
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-slate-500 font-bold uppercase tracking-[0.2em] text-xs"
        >
          <button
