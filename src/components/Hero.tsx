...
// PLACEHOLDER — replace with the studio's own featured track embed link.
const FEATURED_EMBED = 'https://open.spotify.com/embed/track/4cOdK2wGLETKBW3PvgPWqT?utm_source=generator&theme=0';
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="flex items-center justify-between mb-5">
              <p className="text-xs font-medium text-accent uppercase tracking-[0.2em]">Featured song</p>
              <span className="text-xs text-stone-500">Made for a customer</span>
            </div>
            <SpotifyEmbed src={FEATURED_EMBED} title="Featured custom song" compact={false} />
